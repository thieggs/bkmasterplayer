#!/usr/bin/env bash
# Gera o APK do BK Music Player para celulares Android (arm64, quase todos os atuais).
# Uso: ./dev/build_apk.sh            (ou ALL_ABIS=1 para incluir arm 32 bits e x86_64)
# Saída: dist/bkmusicplayer_<versão>_<abi>.apk
#
...
mkdir -p "$ROOT/dist"
OUT="$ROOT/dist/bkmusicplayer_${BASE}+${CODE}_${ABI}.apk"
