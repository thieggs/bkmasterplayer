...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1776255514;
...
abstract class RustLibApi extends BaseApi {
  ...
  void crateApiEnginePlayerPrepareVinyl({required double memorySecs});
  ...
  BigInt crateApiEnginePlayerVinylMaxBytes();

  String crateApiPortalPortalFingerprint({required String key});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void crateApiEnginePlayerPrepareVinyl({required double memorySecs}) {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_f_32(memorySecs, serializer);
        ...
        constMeta: kCrateApiEnginePlayerPrepareVinylConstMeta,
        argValues: [memorySecs],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEnginePlayerPrepareVinylConstMeta =>
      const TaskConstMeta(
        debugName: "player_prepare_vinyl",
        argNames: ["memorySecs"],
      );
  ...
  BigInt crateApiEnginePlayerVinylMaxBytes() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiEnginePlayerVinylMaxBytesConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiEnginePlayerVinylMaxBytesConstMeta =>
      const TaskConstMeta(debugName: "player_vinyl_max_bytes", argNames: []);
  ...
  String crateApiPortalPortalFingerprint({required String key}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiPortalPortalFingerprintConstMeta,
        argValues: [key],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPortalPortalFingerprintConstMeta =>
      const TaskConstMeta(debugName: "portal_fingerprint", argNames: ["key"]);
